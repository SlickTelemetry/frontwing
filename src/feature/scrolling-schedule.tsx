...
const ScheduleComponent: React.FC = () => {
  ...
  return (
    <div className='scrollbar scrollbar-thumb-accent/50 scrollbar-track-muted flex w-full items-center justify-start gap-4 overflow-x-scroll border border-b p-4 lg:px-6'>
